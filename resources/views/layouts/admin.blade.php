{{-- Nom : layouts/admin.blade.php | Rôle : Structure principale (Layout) de l'espace Administrateur (Menu, Topbar, Scripts) --}}
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
    ...
    <style>
        {{-- Variables CSS pour la charte graphique premium --}}
        :root {
        ...
        /* Profil de l'utilisateur en bas du menu */
        .user-profile {
            padding: 1.25rem;
            margin: 1rem;
        ...
        .top-bar {
            ...
            top: 0;
            z-index: 800;
            margin: -1.5rem -1.5rem 1.5rem -1.5rem; /* Negate main-content padding */
        }
...
<body>
    ...
    {{-- Barre latérale de navigation (Menu principal) --}}
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            ...
            @elseif(Auth::user()->role === 'receptionniste')
            ...
            <div class="menu-category">GESTION DES OPÉRATIONS</div>
            ...
            @if(Auth::user()->role == 'admin')
            <div class="menu-category">STATISTIQUES & RAPPORTS</div>
    ...
    <main class="main-content">
        ...
        <header class="top-bar">
            <div class="d-flex align-items-center gap-3">
                {{-- Menu des notifications en temps réel --}}
                <div class="dropdown">
