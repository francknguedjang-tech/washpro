                            ...
                            <table class="table table-hover align-middle mb-0" id="articlesTable">
                                ...
                                <tbody>
                                    <tr class="article-row border-bottom border-light">
                                        ...
                                        <td class="py-3">
                                            <input type="number" name="articles[0][quantite]" 
                                                   class="form-control form-control-lg border-2 border-primary text-center fw-black text-dark fs-4 qte-input rounded-3 shadow-sm" 
